<template>
  <div class="newObj_wrapper">
    ...
    <div class="newObj_btn">
      ...
      <my-button @click="deleteItem()" style="width: 40px"> - </my-button>
    </div>
  ...
  data() {
    return {
      newDish: {
        ...
        comment: "",
        id: "1",
        listOfIngredients: [{ name: "", quantity: "", id: 1 }],
      },
    };
  },
  methods: {
    addItem() {
      this.newDish.listOfIngredients.push({
        name: "",
        quantity: "",
        id: Date.now(),
      });
